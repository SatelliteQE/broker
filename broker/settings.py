...
# Add helper function to determine settings file for a specific component
def component_settings_path(component_name):
    """Get the settings file path for a specific component.
    ...
    """
    return BROKER_DIRECTORY.joinpath(f"{component_name}_settings.yaml")
